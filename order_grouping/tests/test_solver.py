...
class TestSolver:
        ...
        result = self._solve(
            {
                ...
                "courier_capacity_boxes": [10],
                "boxes_per_order": [1, 1],
                "order_created_offset": [0, 0],
                "order_ready_offset": [0, 0],
                "courier_available_offset": [0],
                "W_cert": 100,
                "W_c2e": 1,
                "W_skip": 1000,
        ...
        result = self._solve(
            {
                ...
                "courier_capacity_boxes": [3],
                "boxes_per_order": [1, 1],
                "order_created_offset": [0, 0],
                "order_ready_offset": [30, 0],
                "courier_available_offset": [0],
                "W_cert": 100,
                "W_c2e": 1,
                "W_skip": 1000,
    ...
    def test_tc_008_assign_to_earliest_available_courier(self) -> None:
        ...
        result = self._solve(
            {
                "tau": [[0, 10, 10], [10, 0, 10], [10, 10, 0]],
                "courier_capacity_boxes": [10, 10],
                "boxes_per_order": [1, 1],
                "order_created_offset": [0, 0],
                "order_ready_offset": [0, 0],
                "courier_available_offset": [0, 100],
                "W_cert": 100,
                "W_c2e": 1,
                "W_skip": 1000,
            }
        ...
        result = self._solve(
            {
                ...
                "courier_capacity_boxes": [10],
                "boxes_per_order": [1, 1, 1],
                "order_created_offset": [0, 0, 0],
                "order_ready_offset": [0, 0, 0],
                "courier_available_offset": [0],
                "W_cert": 1,
                "W_c2e": 10,
                "W_skip": 10000,
